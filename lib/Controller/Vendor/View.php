...
class View extends \App\Controller\Base
{
	function __invoke($REQ, $RES,$ARG)
	{
		...
		$data = array(
			'Page' => array('title' => 'Vendor :: Detail'),
		...
		$sql.= ' WHERE crm_transfer.company_id = :c AND source_license_id = :l';
		...
		// Show all Vendor Transfers
		$sql = 'SELECT crm_transfer.guid, crm_transfer.flag, crm_transfer.created_at, crm_transfer.completed_at, crm_transfer.stat, crm_transfer.full_price, license.code AS source_license_code, license.name AS source_license_name';
		$sql.= ', count(crm_transfer_item.id) AS lot_count';
		$sql.= ' FROM crm_transfer';
		$sql.= ' JOIN license ON crm_transfer.source_license_id = license.id';
		$sql.= ' LEFT JOIN crm_transfer_item ON crm_transfer.id = crm_transfer_item.transfer_id';
		$sql.= ' WHERE crm_transfer.company_id = :c AND source_license_id = :l';
		...
		//return $this->_container->pwig->render($RES, 'page/vendor/view.php', $data);
		return $this->_container->view->render($RES, 'page/vendor/view.html', $data);
